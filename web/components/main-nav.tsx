...
const NAV_ITEMS = [
  ...
  { href: "/table", label: "Table", match: (p: string) => p.startsWith("/table") },
  { href: "/stats", label: "Statistics", match: (p: string) => p.startsWith("/stats") },
];
      ...
      <header className="sticky top-0 z-40 bg-ink/95 backdrop-blur-md text-white border-b border-white/10 shadow-sm">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3 sm:py-3.5">
          ...
          >
            ...
            <span className="hidden sm:inline">Search clubs, players...</span>
